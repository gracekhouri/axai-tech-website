                    ...
                    <div className="p-5">
                        ...
                        <div className="p-1">
                            <p>
                                ...
                                most notably it's comparatively low invasiveness.
                                For patients for which tissue-based testing is not appropriate or is not available, 
                                liquid biopsy can provide a safe alternative test for determining targeted therapy 
                                and monitoring treatment efficacy and disease progression.
                            </p>
                        </div>
                    </div>
